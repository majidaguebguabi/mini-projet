...
<section class="accounts">
   ...
   <div class="box">
      ...
      <p>Add now user</p>
      <a href="register_admin.php" class="option-btn">Admin login</a>
   ...
   <div class="box">
      ...
      <div class="flex-btn">
         ...
         <a href="admin_accounts.php?delete=<?= $fetch_accounts['id']; ?>" onclick="return confirm('supprimer ce compte?')" class="delete-btn">Delete</a>
         <?php
