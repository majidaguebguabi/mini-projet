      ...
      <div class="flex">
        ...
        <div class="inputBox">
         ...
         <div class="inputBox">
            ...
            <select class="box" name="category" placeholder="enter product categorie" required maxlength="500" cols="30" rows="10">
            <?php
...
<section class="show-products">
   ...
   <div class="box">
      ...
      <div class="price"><strong ><span><?= $fetch_products['price']; ?></span>Dhs </strong></div>
